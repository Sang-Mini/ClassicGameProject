...
<script>
	...
	var snakeColor = "#ED5B5B", tileColor = "#EEEEEE"
	...
	function drawBoard() {
		...
		for (var i = 0; i < MY; i++) {
			boardTag += "<tr>";
			for (var j = 0; j < MX; j++)
				boardTag += "<td id=\"" + String(i) + " " + String(j)
						+ "\"></td>";
			boardTag += "</tr>";
		}
		boardTag += "</table>"
	...
	function gameover() {
	    ...
	    let nick = "<c:out value='${sessionScope.user.nickname}'/>";
	    
	    xhttp.open("POST", "../insertCgame2", true);
	    xhttp.setRequestHeader("Content-type", "application/x-www-form-urlencoded;charset=UTF-8");
	    xhttp.send("nickname=" + nick + "&score2=" + score);
